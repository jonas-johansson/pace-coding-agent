...
Come up with a name for this coding agent: boom, wing, cush

Leading user message with # symbol means it will add the user text to AGENTS.md in the cwd.

Replace home dir with ~/ for cwd in prompt

Teach AI to use find while ignoring node_modules (or anything else in .gitignore).

Teach AI to use relative paths for things in the working directory.